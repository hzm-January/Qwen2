...
class TrainArgPath(Enum):
    ...
    # TRAIN_DATASET_PATH = '/public/njllm/hzm/code/qwen2/ai_doctor/source/dpo_fs_train_data.jsonl'
    # TRAIN_DATASET_PATH = '/public/njllm/hzm/code/qwen2/ai_doctor/source/dpo_train_data.jsonl'
