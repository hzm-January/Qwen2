...
class TrainArgPath(Enum):
    ...
    # TRAIN_DATASET_PATH = '/data1/llm/hzm/code/qwen2/ai_doctor/source/dpo_fs_train_data.jsonl'
    # TRAIN_DATASET_PATH = '/data1/llm/hzm/code/qwen2/ai_doctor/source/dpo_train_data.jsonl'
    TRAIN_DATASET_PATH = '/data1/llm/hzm/model/qwen2-dpo'
    # MODLE_PATH = f'/data1/llm/hzm/model/qwen2-sft/{dir_id}'
    MODLE_PATH = f'/data1/llm/hzm/model/qwen2-sft'
    TASK_TYPE = 'dpo_multi'
