...
class TrainArgument(DPOConfig):
    ...
    """
    output_dir: str = field(default='/data/whr/hzm/model/qwen2-dpo', metadata={"help": "模型训练完成后的保存路径"})
    ...
    deepspeed: Optional[str] = field(default='/data/whr/hzm/code/qwen2/ai_doctor/dpo/train_args/deepspeed_config/ds_config_zero2.json',
    ...
    # label_smoothing_factor: Optional[float] = 0.1
    fix_llm: bool = False
