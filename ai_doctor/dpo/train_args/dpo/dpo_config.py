...
class TrainArgument(DPOConfig):
    ...
    """
    output_dir: str = field(default='/data1/llm/hzm/model/qwen2-dpo', metadata={"help": "模型训练完成后的保存路径"})
    ...
    deepspeed: Optional[str] = field(default='/data1/llm/hzm/code/qwen2/ai_doctor/dpo/train_args/deepspeed_config/ds_config_zero2.json',
