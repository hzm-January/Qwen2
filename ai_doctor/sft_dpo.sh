...
do
  ...
  /public/whr/anaconda3/envs/hzm-qwen2-01/bin/python3.9 /public/whr/hzm/code/qwen2/ai_doctor/data/dataset_process.py --digit-to-word $DIGIT_TO_WORD --selected $SELECTED 2>&1 | tee "$SFT_OUTPUT_DIR/train_model.log"
  ...
  ## 4 sft test
  /public/whr/anaconda3/envs/hzm-qwen2-01/bin/python3.9 /public/whr/hzm/code/qwen2/ai_doctor/test/qwen2_sft_diagnose_test.py --dir-id $DIR_ID --selected $SELECTED  2>&1 | tee -a "$SFT_OUTPUT_DIR/train_model.log"
  ## 5 dpo train
  ...
  # 6 dpo test
  /public/whr/anaconda3/envs/hzm-qwen2-01/bin/python3.9 /public/whr/hzm/code/qwen2/ai_doctor/test/qwen2_dpo_diagnose_test.py --dir-id $DIR_ID --selected $SELECTED 2>&1 | tee -a "$DPO_OUTPUT_DIR/train_model.log"
done