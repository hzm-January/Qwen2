...
column_name_json = '/public/njllm/hzm/code/qwen2/ai_doctor/source/patient_infos_column_name_0_1_2.json'

generation_config_dir = '/public/njllm/hzm/code/qwen2/ai_doctor/feature_select/'
