...
column_name_json = '/data1/llm/hzm/code/qwen2/ai_doctor/source/patient_infos_column_name_0_1_2.json'

generation_config_dir = '/data1/llm/hzm/code/qwen2/ai_doctor/feature_select/'
...
def load_config():
    ...
    parser.add_argument('--ds_config', type=str,
                        default='/data1/llm/hzm/code/qwen2/ai_doctor/config/dataset_config.yaml')
    parser.add_argument('--ft_config', type=str,
                        default='/data1/llm/hzm/code/qwen2/ai_doctor/config/finetune_config.yaml')
