...
OUTPUT_DIR="/data1/llm/hzm/model/qwen2/qwen2-sft/$DIR_ID"
...
/data1/llm/anaconda3/envs/hzm-qwen2/bin/python3.10 /data1/llm/hzm/code/qwen2/ai_doctor/data/dataset_process_feature_select.py 2>&1 | tee "$OUTPUT_DIR/train_model.log"
# 2 copy dataset from ai_doctor to output_dir/source/
mkdir -p $OUTPUT_DIR/source
cp -r /data1/llm/hzm/code/qwen2/ai_doctor/source/*.jsonl $OUTPUT_DIR/source
# 3 sft train
eval $run_sh 2>&1 | tee "$OUTPUT_DIR/train_model.log"
## 4 sft test
/data1/llm/anaconda3/envs/hzm-qwen2/bin/python3.10 /data1/llm/hzm/code/qwen2/ai_doctor/test/qwen2_sft_diagnose_test.py --dir-id $DIR_ID  2>&1 | tee "$OUTPUT_DIR/train_model.log"
## 5 dpo train
deepspeed --include localhost:$CUDA_IDS main_train.py --dir-id $DIR_ID
# 6 dpo test
/data1/llm/anaconda3/envs/hzm-qwen2/bin/python3.10 /data1/llm/hzm/code/qwen2/ai_doctor/test/qwen2_dpo_diagnose_test.py --dir-id $DIR_ID